...
-------- | -------------
databases.version | Define the used PostgreSQL major version. Default: 18. Supported versions: 15, 16, 17, 18
...
The [CI pipeline](https://bosh.ci.cloudfoundry.org/teams/databases/pipelines/postgres-release) runs:
